...
public class Settings
{
    ...
    [SettingName("Remove Lockpicks from Container item lists")]
    [Tooltip("When enabled, any Container record whose item list references the Lockpick MiscItem (directly, or indirectly via a Leveled List that contains only lockpicks) will have those entries removed.")]
    public bool RemoveLockpicksFromContainers { get; set; } = false;
}
